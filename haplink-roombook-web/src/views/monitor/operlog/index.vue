<template>
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="固资物料编号" prop="operParam" label-width="220" >
        <el-input
          v-model="queryParams.operParam"
          placeholder="请输入固资物料编号"
          clearable
          style="width: 240px;"
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table class="no-border" stripe ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
